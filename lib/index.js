...
let YTPlayer = module.exports = class YTPlayer extends Emitter {
     ...
     * @function
     * @name onYTReady
     * @param {Function} cb The callback function to invoke when the API is ready.
     * @returns {void}
     */
    static onYTReady(cb) {
     ...
     * @function
     * @name constructor
     * @param {string|HTMLElement} id The ID of the container element or the element itself.
     * @param {Object} options Configuration options for the player.
     * @param {Object} [options.events={}] Event handlers to attach to the player.
     * @param {boolean} [options.handleFullscreen=false] Whether to handle fullscreen changes.
     * @param {number} [options.fullscreenIntervalCheck=500] Interval in ms for fullscreen checks.
     * @returns {void}
     */
     ...
     * @function
     * @name _onStateChange
     * @param {Object} e The YouTube state change event object.
     * @param {number} data The player state code.
     * @returns {void}
     */
     ...
     * @param {Function} cb The callback function to invoke when the event fires.
     * @returns {YTPlayer} This instance for chaining.
     */
    on(ev, cb) {
     ...
     * @function
     * @name off
     * @param {string} ev The event name to stop listening for.
     * @param {Function} cb The callback function to remove.
     * @returns {YTPlayer} The result of the parent removeListener method.
     */
    off(ev, cb) {
        ev = lcFirst(ev.replace(/^on/, ""))
     ...
     * @function
     * @name ready
     * @param {Function} cb The callback function to invoke when the player is ready.
     * @returns {YTPlayer} This instance for chaining.
     */
    ready(cb) {
     ...
     * @function
     * @name safePlay
     * @returns {Promise<YTPlayer>} A promise that resolves to this instance when playback succeeds, or rejects with an error.
     */
    async safePlay() {
        if (isAndroidOrIOS) return this;
        ...
        return new Promise((resolve, reject) => {
            ...
            bufferingCheckId = setInterval(() => {
                ...
                if (elapsed > 10000) {
                    ...
                    bufferingSince = Date.now(); // reset timer
                    restartPlayback();
                }
            }, 1000);
